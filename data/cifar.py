...
def get_cifar_100_datasets(train_transform, test_transform, train_classes=range(80),
    ...
    # Init entire training set
    whole_training_set = CustomCIFAR100(root=args.cifar_100_root, transform=train_transform, train=True)
    ...
    # Get test set for all classes
    test_dataset = CustomCIFAR100(root=args.cifar_100_root, transform=test_transform, train=False)
