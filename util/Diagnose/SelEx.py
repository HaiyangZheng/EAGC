...
def train(projection_head, model, train_loader, test_loader, unlabelled_train_loader, merge_train_loader, labeled_eval_loader, args):
    ...
    for epoch in range(args.epochs):
        ...
        for batch_idx, batch in enumerate(tqdm(train_loader)):
            ...
            if (batch_idx % args.gdc_every == 0) and mask_lab.any():
                gdc_value = compute_gdc(loss_sup, loss_unsup, model)
        ...
        #         save_name = f"{args.dataset_name}_SelEx_best_seed{args.seed}.pth"
        ...
        #         logger.log({
        #             "best/all_acc": best_all_acc,
        #             "best/old_acc": best_old_acc,
        #             "best/new_acc": best_new_acc,
        ...
        # # 构造保存路径
        # os.makedirs(args.save_path, exist_ok=True)
        # save_name = f"{args.dataset_name}_SelEx_original_seed{args.seed}.pth"
        # save_path = os.path.join(args.save_path, save_name)
